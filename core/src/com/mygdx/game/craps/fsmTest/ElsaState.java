...
public enum ElsaState implements State<com.mygdx.game.craps.fsmTest.Elsa> {

    DO_HOUSE_WORK() {
        @Override
        public void update (com.mygdx.game.craps.fsmTest.Elsa elsa) {
        ...
        @Override
        public boolean onMessage(com.mygdx.game.craps.fsmTest.Elsa entity, Telegram telegram) {
            return false;
        }
    },
    ...
    VISIT_BATHROOM() {
        @Override
        public void enter (com.mygdx.game.craps.fsmTest.Elsa elsa) {
        ...
        @Override
        public void exit (com.mygdx.game.craps.fsmTest.Elsa elsa) {
    ...
    COOK_STEW() {
        ...
        @Override
        public boolean onMessage (com.mygdx.game.craps.fsmTest.Elsa elsa, Telegram telegram) {
    ...
    protected void talk (com.mygdx.game.craps.fsmTest.Elsa elsa, String msg) {
