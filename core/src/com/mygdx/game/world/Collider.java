...
public class Collider { //todo fix accessibility , only for WorldManager
    public boolean upLockFinal;
    public boolean downLockFinal;
    public boolean leftLockFinal;
    public boolean rightLockFinal;
...
//    private Rectangle[] rectangles;
    ...
    public Collider(int firstChunkEntitiesCount) {
