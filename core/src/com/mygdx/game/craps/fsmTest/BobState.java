...
enum BobState implements State<com.mygdx.game.craps.fsmTest.Bob> {
    ENTER_MINE_AND_DIG_FOR_NUGGET() {
        @Override
        public void enter (com.mygdx.game.craps.fsmTest.Bob bob) {
        ...
        @Override
        public void update (com.mygdx.game.craps.fsmTest.Bob bob) {
        ...
        @Override
        public void exit (com.mygdx.game.craps.fsmTest.Bob bob) {
    ...
    GO_HOME_AND_SLEEP_TILL_RESTED() {
        ...
        @Override
        public boolean onMessage (com.mygdx.game.craps.fsmTest.Bob bob, Telegram telegram) {
    ...
    VISIT_BANK_AND_DEPOSIT_GOLD() {
        ...
        public void update (com.mygdx.game.craps.fsmTest.Bob bob) {
            ...
            if (bob.getWealth() >= com.mygdx.game.craps.fsmTest.Bob.COMFORT_LEVEL) {
    ...
    protected void talk (com.mygdx.game.craps.fsmTest.Bob bob, String msg) {
