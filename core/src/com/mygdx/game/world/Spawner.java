...
public class Spawner{ // todo make singleton
...
//    private boolean isDestroying;
    ...
    private Job job; //todo prototype
    private Vector1 destination;
    private Vector2[] vvv;
    private Npc[] pumps;
    public void setJob(Clock clock){ //todo prototype
        job = new Job();
        job.hrs = 1;
    ...
    private com.mygdx.game.world.Collider collider;
